...
class JetFlavourHelper:
    def __init__(self, coll, jet, jetc,njet, tag=""):
        ...
        #self.dndx = coll["dNdx"]   #no particle identification in FCChh
        ...
        self.definition["pfcand_px{}".format(self.tag)] = "JetConstituentsUtils::PPP::get_px({})".format(self.const)
        self.definition["pfcand_py{}".format(self.tag)] = "JetConstituentsUtils::PPP::get_py({})".format(self.const)
        self.definition["pfcand_pz{}".format(self.tag)] = "JetConstituentsUtils::PPP::get_pz({})".format(self.const)
        self.definition["pfmask{}".format(self.tag)] = "JetConstituentsUtils::PPP::mask_pt_positive({})".format(self.const)
