...
def main():
    ...
    from config import variables_pfcand, variables_jet, variables_event, flavors
    ...
    sample_a = {
            "file": "{}/stage2_tt.root".format(input_dir),
            "flavor": "t",
...
def plot(sample_a, sample_b, histo_coll, var, params, outdir):
    ...
    text.DrawLatex(0.14, 0.91, "FCC-hh")
    text.SetTextFont(42)
    text.DrawLatex(0.27, 0.91, "(Delphes Simulation)")
    text.SetTextSize(0.05)
    text.DrawLatex(0.25, 0.78, "pp #rightarrow jj")
    text.SetTextSize(0.04)
    text.DrawLatex(0.28, 0.71, "j = q, t")
    text.SetTextSize(0.05)
    text.SetTextAlign(31)
    text.DrawLatex(0.95, 0.91, "#sqrt{s} = 84 TeV")
