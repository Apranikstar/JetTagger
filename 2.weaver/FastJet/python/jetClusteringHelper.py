...
class InclusiveJetClusteringHelper:
    def __init__(self, coll, coneRadius, ptcut, tag=""):

        self.input_coll = coll
        self.coneR = coneRadius
        self.ptCut = ptcut 
        self.tag = tag
        ...
        self.definition[_jet] = "JetClustering::clustering_antikt(0.4, 0, 50, 0,0 )(pjetc)"#.format(self.coneR, self.ptCut,pjetc)
